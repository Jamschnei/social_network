...
<body>
	<div class="main">
		<form class = "small quiet" action="/signup" method="post">
			...
			<div class = "floatLeft">
				<ul>
					<li><input type="text" name="username" class="simpleInput quiet" /></li>
					<li><input type="text" name="realName" class="simpleInput quiet" /></li>
					<li><input type="text" name="email" class="simpleInput quiet" /></li>
